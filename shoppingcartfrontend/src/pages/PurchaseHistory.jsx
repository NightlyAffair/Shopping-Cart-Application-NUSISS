...
const PurchaseHistory = () => {
  ...
  return (
      <div style={{ display: "flex", width: "100vw", flexDirection: "column", minHeight: '100vh' }}>
        <div>
          <Header />
        </div>
        <div>
        ...
        <div style={{ display: "flex", flexDirection: "row", flex: 1 }}>
          ...
          <div style={{ padding: "20px", flex: 1 }}>
            ...
            {!loading && !error && orders.length === 0 && <p>No purchase history found</p>}
                      ...
                      <div key={order.orderId} style={{ marginBottom: "40px" }}>
                        ...
                        >
                          ...
                          {order.orderDetails?.map((detail) => {
                            ...
                            const subtotal = product.unitPrice ? product.unitPrice * detail.quantity : 0;

                            const handleProductClick = (productId) => {
                              window.location.href = `http://localhost:8080/products/details/${productId}`;
                            };
                        ...
                        {showExistingReview && selectedOrderId === order.orderId && (
                            <div style={modalOverlayStyle} onClick={closeExistingReviewModal}>
                              <div style={modalStyle} onClick={(e) => e.stopPropagation()}>
                                ...
                                <button
                                    onClick={closeExistingReviewModal}
                                    style={{
                                      padding: '8px 14px',
                                      background: '#007bff',
                                      color: 'white',
